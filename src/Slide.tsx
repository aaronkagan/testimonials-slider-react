      ...
      <div className="col-right-wrapper">
        <div className="col-right">
          ...
          <div className="buttons">
            <img
              className="button"
              src="/public/assets/images/icon-prev.svg"
              alt="Previous"
              onClick={() =>
            ...
            <img
              className="button"
              src="/public/assets/images/icon-next.svg"
              alt="Next"
              onClick={() =>
                onActiveSlide((prevVal: number) =>
...
const StyledMain = styled.main`
  ...
  .col-left-wrapper {
    ...
    &::before {
      ...
      width: 100%;
      height: 100%;
      background-image: url('/public/assets/images/pattern-quotes.svg');
  ...
  .col-right-wrapper {
    background-image: url('/public/assets/images/pattern-bg.svg');
    background-size: 80%;
    background-repeat: no-repeat;
